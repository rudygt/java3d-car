...
public class CarBuilder {
    ...
    public static Node getRueda() {
        ...
        Appearance appR1 = Tools.cargarTextura("c:\\3d\\tiret12.png");

        Appearance appR2 = Tools.cargarTextura("c:\\3d\\tire9b.png");

        Appearance appR3 = Tools.cargarTextura("c:\\3d\\tire19.png");
